package com.example.securedwebapplication.LowLevelDataBase;
...
public class RecordsFile extends BaseRecordsFile {
     ...
     * is cached in memory. The hashtable maps a key of type String to a ss.RecordHeader.
     */
    ...
    /**
     * This method searches the file for free space and then returns a ss.RecordHeader
     ...
     * in the file is part of the record data of the ss.RecordHeader which is returned.  Returns null if
    ...
    protected int getId(){
        int ID= getNumRecords()+1;
        Enumeration enumeration=enumerateKeys();
        return ID;
    }
