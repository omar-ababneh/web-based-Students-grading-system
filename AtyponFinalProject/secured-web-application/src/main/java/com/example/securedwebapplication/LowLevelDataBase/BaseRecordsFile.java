...
public abstract class BaseRecordsFile {
    ...
    /**
     * Locates space for a new record of dataLength size and initializes a ss.RecordHeader.
     */
    ...
    /**
     * Updates the contents of the given record. A ss.RecordsFileException is thrown if the new data does not
